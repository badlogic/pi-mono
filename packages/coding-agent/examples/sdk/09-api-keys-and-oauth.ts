...
import { createAgentSession, JSONFileAuthStorage, ModelRegistry, SessionManager } from "@mariozechner/pi-coding-agent";
...
const customAuthStorage = new JSONFileAuthStorage("/tmp/my-app/auth.json");
