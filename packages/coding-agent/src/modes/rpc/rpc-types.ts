...
// ============================================================================
// RPC Session List (for list_sessions response)
// ============================================================================
...
/** Shared fields for all tree node variants */
 ...
 *
 * Metadata-only entries (label, session_info, custom) are filtered out and
 * their children are promoted to the nearest projected parent.
 */
export type RpcTreeNode =
	| (RpcTreeNodeBase & {
			type: "message";
			role: "user" | "assistant" | "bashExecution" | "custom" | "branchSummary" | "compactionSummary" | "unknown";
