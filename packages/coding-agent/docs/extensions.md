...
Automatic retries, compaction, or queued work can continue afterward.
Use `agent_settled` when an integration needs to know Pi will not continue automatically.
