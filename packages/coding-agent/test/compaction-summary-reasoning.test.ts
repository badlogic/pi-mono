...
import type { AssistantMessage, Model } from "@apholdings/jensen-ai";
...
vi.mock("@apholdings/jensen-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@apholdings/jensen-ai")>();
	return {
		...actual,
