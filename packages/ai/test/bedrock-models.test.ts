 ...
 *
 * This test suite is not enabled by default unless `AWS_PROFILE` and `BEDROCK_EXTENSIVE_MODEL_TEST` environment variables are passes.
...
describe("Amazon Bedrock Models", () => {
	...
	if (process.env.AWS_PROFILE && process.env.BEDROCK_EXTENSIVE_MODEL_TEST) {
